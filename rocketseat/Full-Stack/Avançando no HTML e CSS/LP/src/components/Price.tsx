...
function Price() {
    return (
        <section className="py-12 px-6 flex flex-col gap-8">
            <div className="text-center">
                <h3 className="font-meidum text-[14px] text-[#F7B733]">PLANOS E PREÇOS</h3>
                <h2 className="mt-2 font-extrabold text-[24px] leading-[120%]">Assine e tenha acesso ilimitado a todas as funcionalidades</h2>
            </div>
            <div className="grid grid-cols-1 gap-8">
                <div className="p-6 bg-[#18181B] rounded-3xl border border-[#27272A]">
                ...
                <div className="rounded-3xl bg-linear-to-r from-[#FC4B1A] to-[#F7B733] p-0.75">
                    <div className="rounded-3xl bg-[#18181B]">
