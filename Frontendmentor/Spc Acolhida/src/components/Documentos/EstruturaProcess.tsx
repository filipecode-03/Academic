function EstruturaProcess() {
    return (
        <div className="bg-[#F8F8F8] p-8">
            <h2 className="text-center text-[#01314A] font-bold text-3xl lg:text-4xl">Estrutura de cada tipo de processo com seus devidos modelos</h2>
            <div className="max-w-7xl grid grid-cols-1 gap-10 lg:grid-cols-4 mx-auto mt-7">
                <div className="max-w-75">
                    <h1 className="font-bold text-2xl text-center">Pregões</h1>
...
export default EstruturaProcess