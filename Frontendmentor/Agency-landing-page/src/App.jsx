...
import juiceDesktop from './assets/images/desktop/image-stand-out.jpg'
...
import Sec02 from './assets/components/Sec02'
  ...
  return (
    <div className="min-h-screen font-['Barlow']">
      ...
      <div className='text-center lg:text-left lg:flex lg:flex-row-reverse'>
        <img src={eggMobile} alt="egg" className='block lg:hidden' />
        <img src={eggDesktop} alt="egg" className='hidden lg:block lg:w-530' />
        <div className='p-8 lg:p-30 space-y-8 pt-16 lg:pt-40 pb-14'>
          <h1 className="font-['Fraunces'] font-bold text-[35px] lg:text-[55px] w-[80%] lg:w-full mx-auto leading-10 lg:leading-15">Transform your brand</h1>
          <p className="font-medium text-gray-700 text-[18px] lg:text-[20px]">We are a full-service creative agency specializing in helping brands grow fast. Engage your clients through compelling visuals that do most of the marketing for you.</p>
      ...
      <div className='text-center lg:text-left lg:flex'>
        <img src={juiceMobile} alt="juice" className='block lg:hidden' />
        <img src={juiceDesktop} alt="juice" className='hidden lg:block lg:w-478' />
        <div className='p-8 lg:p-30 space-y-8 pt-16 lg:pt-38 pb-14'>
          <h1 className="font-['Fraunces'] font-bold text-[35px] lg:text-[55px] w-[80%] lg:w-full mx-auto leading-10 lg:leading-15">Stand out to the right audience</h1>
          <p className="font-medium text-gray-700 text-[18px] lg:text-[20px]">Using a collaborative formula of designers, researchers, photographers, videographers, and copywriters, we’ll build and extend your brand in digital places.</p>
          <p className="group relative inline-block w-fit font-extrabold font-['Fraunces'] tracking-[1px] cursor-pointer">
          LEARN MORE
      ...
      <div className='text-center p-8 space-y-15 pt-16 lg:pt-36 pb-14'>
        <h1 className="font-['Fraunces'] font-bold tracking-[5px] text-gray-400 text-[20px]">CLIENT TESTIMONIALS</h1>
        <div className='space-y-15 lg:flex lg:px-20'>
          <div>
            <div className='space-y-8 lg:space-y-15'>
              <img src={emily} alt="emily" className='mx-auto rounded-full w-20' />
              <p className='text-[18px] lg:w-[80%] lg:mx-auto'>We put our trust in Sunnyside and they delivered, making sure our needs were met and deadlines were always hit.</p>
          ...
          <div>
            <div className='space-y-8 lg:space-y-15'>
              ...
              <p className='text-[18px] lg:w-[80%] lg:mx-auto'>Sunnyside’s enthusiasm coupled with their keen interest in our brand’s success made it a satisfying and enjoyable experience.</p>
          ...
          <div>
            <div className='space-y-8 lg:space-y-15'>
              ...
              <p className='text-[18px] lg:w-[80%] lg:mx-auto'>Incredible end result! Our sales increased over 400% when we worked with Sunnyside. Highly recommended!</p>
      ...
      <section>
        <div className="grid grid-cols-2 md:grid-cols-4">
          <img src={milkMobile} alt="milk" className="block lg:hidden w-full h-auto object-cover" />
          <img src={milkDesktop} alt="milk" className="hidden lg:block w-full h-auto object-cover" />
          <img src={orangeMobile} alt="orange" className="block lg:hidden w-full h-auto object-cover" />
          <img src={orangeDesktop} alt="orange" className="hidden lg:block w-full h-auto object-cover" />
          <img src={coneMobile} alt="cone" className="block lg:hidden w-full h-auto object-cover" />
          <img src={coneDesktop} alt="cone" className="hidden lg:block w-full h-auto object-cover" />          
          <img src={sugarMobile} alt="sugar" className="block lg:hidden w-full h-auto object-cover" />
          <img src={sugarDesktop} alt="sugar" className="hidden lg:block w-full h-auto object-cover" />
        </div>
      </section>
      <footer className='bg-[#90D4C5] pt-18 pb-20 px-10'>
        <img src={logoGreen} alt="logo green" className='mx-auto' />
        <div className='flex mt-12 justify-between text-[18px] text-[#266758] w-[80%] lg:w-[25%] mx-auto'>
        ...
        <div className='mt-22 flex justify-between w-[50%] lg:w-[15%] mx-auto'>
