        ...
        <div className="mt-20 flex flex-col gap-15">
            ...
            <div className="pl-8 flex flex-col gap-10">
                <div>
                    ...
                    <p className="text-gray-500 mt-3">See how your day-to-day tasks fit into the wider vision. Go from tracking progress at the milestone level all the way done to the smallest of details. Never lose sight of the bigger picture again.</p>
                </div>
                <div>
                    <div className="bg-[#FFF0EB] flex rounded-l-full items-center gap-3">
                    ...
                    <p className="text-gray-500 mt-3">Set internal delivery estimates and track progress toward company goals. Our customisable dashboard helps you build out the reports you need to keep key stakeholders informed.</p>
                </div>
                <div>
                    <div className="bg-[#FFF0EB] flex rounded-l-full items-center gap-3">
                    ...
                    <p className="text-gray-500 mt-3">Stop jumping from one service to another to communicate, store files, track tasks and share documents. Manage offers an all-in-one team productivity solution.</p>
                </div>
            </div>
        </div>
    )
