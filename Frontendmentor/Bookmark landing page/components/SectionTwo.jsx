...
function SectionTwo() {
    ...
    return (
        <section className="mt-20 lg:mt-100 text-center">
            <h2 className="text-[25px] font-medium">Features</h2>
            <p className="text-gray-500 mt-2 px-12 lg:w-[42%] lg:mx-auto lg:text-[18px]">Our aim is to make it quick and easy for you to access your favourite websites. Your bookmarks sync between your devices so you can access them on the go.</p>
            <div className="px-12 lg:w-[53%] lg:mx-auto">
                <div className="mt-10 flex flex-col lg:flex-row lg:justify-center lg:gap-30 border-t lg:border-t-0 border-b border-gray-200">
                    ...
                    Simple Bookmarking
                    <span
                        className={`absolute -bottom-px left-1/2 lg:left-19 -translate-x-1/2 h-1 w-32 lg:w-62 bg-red-500
                    ...
                    Speedy Searching
                    <span
                        className={`absolute -bottom-px left-1/2 -translate-x-1/2 h-1 w-32 lg:w-62 bg-red-500
                        transform transition-all duration-300
            ...
            <div className='relative'>
                {active === "btn1" && <img src={tab1} alt="hero" className="px-10 absolute top-14 left-0 lg:left-50 z-10" />}
                {active === "btn2" && <img src={tab2} alt="hero" className="px-10 absolute top-14 left-0 lg:left-50 z-10" />}
                {active === "btn3" && <img src={tab3} alt="hero" className="px-10 absolute top-14 left-0 lg:left-50 z-10" />}
                <div className="relative top-25 bg-[#4F63D6] h-65 lg:h-95 w-100 lg:w-150 mr-auto rounded-tr-full rounded-br-full"></div>
            </div>
            {active === "btn1" && (
                <div className='mt-40 text-center lg:text-left px-12 lg:w-[32%] lg:absolute lg:left-200 lg:top-250'>
                    <h2 className='font-medium text-[25px] lg:text-[30px] leading-12'>Bookmark in one click</h2>
            ...
            {active === "btn2" && (
                <div className='mt-50 text-center lg:text-left px-12 lg:w-[32%] lg:absolute lg:left-200 lg:top-250'>
