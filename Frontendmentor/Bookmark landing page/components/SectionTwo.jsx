...
function SectionTwo() {
    ...
    return (
        <section className="mt-20 text-center">
            ...
            <div className="px-12">
                <div className="mt-10 flex flex-col py-4 gap-4 border-t border-b border-gray-200">
                    <button onClick={() => setActive("btn1")}>Simple Bookmarking</button>
                    <button onClick={() => setActive("btn2")} className="border-t border-gray-200 pt-4">Speedy Searching</button>
                    <button onClick={() => setActive("btn3")} className="border-t border-gray-200 pt-4">Easy Sharing</button>
                </div>
            </div>
            ...
            {active === "btn1" && (
                <div className='mt-40 text-center px-12'>
                    ...
                    <p className='mt-4 text-gray-500 leading-7'>Organize your bookmarks however you like. Our simple drag-and-drop interface gives you complete control over how you manage your favourite sites.</p>
                </div>
            )}
            {active === "btn2" && (
                <div className='mt-50 text-center px-12'>
                    <h2 className='font-medium text-[25px] leading-12'>Intelligent search</h2>
                    <p className='mt-4 text-gray-500 leading-7'>Our powerful search feature will help you find saved sites in no time at all. No need to trawl through all of your bookmarks.</p>
            ...
            {active === "btn3" && (
                <div className='mt-50 text-center px-12'>
                    ...
                    <p className='mt-4 text-gray-500 leading-7'>Easily share your bookmarks and collections with others. Create a shareable link that you can send at the click of a button.</p>
                    <button className="cursor-pointer bg-[#5266DF] text-white p-2.5 px-4 rounded-[5px] mt-10 font-medium">
                    More Info
                    </button>
                </div>
