...
function SectionOne() {
    return (
        <section>
            ...
            <div className='mt-40 lg:mt-0 lg:absolute lg:left-25 lg:top-60 text-center lg:text-left px-12 lg:w-[38%]'>
                ...
                <div className='mt-8 flex gap-5 justify-center lg:justify-start'>
                    <button className='bg-[#5266DE] hover:bg-white hover:text-[#5266DE] border-3 border-transparent hover:border-[#5266DE] cursor-pointer p-3 rounded-[5px] text-white'>Get it on Chrome</button>
                    <button className='bg-[#F7F7F7] cursor-pointer p-3 shadowBox rounded-[5px] hover:bg-white hover:text-[#5266DE] border-3 border-transparent hover:border-[#5266DE]'>Get it on Firefox</button>
                </div>
            </div>
        </section>
    )
