...
>
                ...
                <div className='text-center lg:text-left lg:w-[32%]'>
                    ...
                    <button className='bg-linear-to-r mt-6 from-[#2BBBC4] to-[#34CF65] p-2.5 px-8 font-semibold rounded-full shadow-2xl text-white transition duration-300 hover:brightness-110 cursor-pointer'>Request Invite</button>
                </div>
        </section>
    )
}
