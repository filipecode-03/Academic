...
function Ticket({ userData }) {
    ...
    return (
        <div className="px-8 min-h-screen text-white">
            ...
            {/* Ticket */}
            <div className="w-full mt-20 h-70 bg-[url('../../public/images/pattern-ticket.svg')] bg-contain bg-center bg-no-repeat p-6">
                {/* Top */}
