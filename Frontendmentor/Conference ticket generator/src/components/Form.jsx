        ...
        <div className="flex justify-center px-8 pb-20">
            <form onSubmit={handleSubmit(onSubmit)} className="w-full mt-12 flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <label htmlFor="avatar" className="border-2 border-dashed border-white/30 bg-white/3 rounded-2xl p-4 cursor-pointer hover:bg-white/10 transition flex flex-col items-center justify-center text-center">
                        {preview ? (
