    ...
    return (
        <div>
                    <section className='mt-12 text-center grid grid-cols-1 lg:grid-cols-4 gap-12 lg:gap-8'>
                        <div className="rounded-[10px] overflow-hidden bg-[#252B43] shadow-2xl hover:bg-gray-700 cursor-pointer">
                            ...
                            <div className="p-8 text-center">
                                ...
                                <p className='tracking-[5px] text-gray-300 font-light'>FOLLOWERS</p>
                        ...
                        <div className="rounded-[10px] overflow-hidden bg-[#252B43] shadow-2xl hover:bg-gray-600 cursor-pointer">
                        ...
                        <div className="rounded-[10px] overflow-hidden bg-[#252B43] shadow-2xl hover:bg-gray-600 cursor-pointer">
                            ...
                            <div className="p-8 text-center">
                                ...
                                <p className='tracking-[5px] text-gray-300 font-light'>SUBSCRIBERS</p>
                                <div className='flex items-center gap-1 justify-center mt-5'>
                    ...
                    <section className='mt-10'>
                        <h1 className='font-bold text-[28px]'>Overview - Today</h1>
                        <div className='grid grid-cols-1 lg:grid-cols-4 gap-6 mt-5'>
                            <div className='bg-[#252B43] shadow-2xl hover:bg-gray-600 cursor-pointer rounded-[10px] p-5 pt-6 px-9 space-y-4'>
                                <div className='flex items-center justify-between'>
                                    <p className='font-medium text-gray-300'>Page Views</p>
                                    <img src={facebook} alt="facebook" />
                                </div>
                                <div className='flex items-center justify-between'>
                            ...
                            <div className='bg-[#252B43] shadow-2xl hover:bg-gray-600 cursor-pointer rounded-[10px] p-5 pt-6 px-9 space-y-4'>
                                <div className='flex items-center justify-between'>
                                    <p className='font-medium text-gray-300'>Likes</p>
                                    <img src={facebook} alt="facebook" />
                                </div>
                                <div className='flex items-center justify-between'>
                            ...
                            <div className='bg-[#252B43] shadow-2xl hover:bg-gray-600 cursor-pointer rounded-[10px] p-5 pt-6 px-9 space-y-4'>
                                <div className='flex items-center justify-between'>
                                    <p className='font-medium text-gray-300'>Profile Views</p>
                                    <img src={instagram} alt="instagram" />
                                </div>
                                <div className='flex items-center justify-between'>
                            ...
                            <div className='bg-[#252B43] shadow-2xl hover:bg-gray-600 cursor-pointer rounded-[10px] p-5 pt-6 px-9 space-y-4'>
                                <div className='flex items-center justify-between'>
                                    <p className='font-medium text-gray-300'>Retweets</p>
                                    <img src={twitter} alt="twitter" />
                                </div>
                                <div className='flex items-center justify-between'>
                            ...
                            <div className='bg-[#252B43] shadow-2xl hover:bg-gray-600 cursor-pointer rounded-[10px] p-5 pt-6 px-9 space-y-4'>
                                <div className='flex items-center justify-between'>
                                    <p className='font-medium text-gray-300'>Total Views</p>
                                    <img src={youtube} alt="youtube" />
                                </div>
                                <div className='flex items-center justify-between'>
