...
function Prin() {
    return (
        <main>
            <div className="rounded-bl-[80px] bg-gray-200 h-130 w-[50%] ml-auto"></div>
            <img src={intro} alt="intro" className='absolute top-35' />
            <section className='absolute p-8 pb-25'>
                ...
                <h1 className='font-["Barlow_Condensed"] mt-5 font-bold text-[#212840] text-[50px] leading-[50px]'>POWERFUL INSIGHTS INTO YOUR TEAM</h1>
                <p className='font-["Barlow_Condensed"] text-[25px] mt-5 text-gray-500 w-[70%]'>Project planning and time tracking for agile teams</p>
