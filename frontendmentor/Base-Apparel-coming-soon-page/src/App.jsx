    ...
    <div className="font-['Josefin_Sans'] bg-gradient-to-b from-white to-[#fff5f5] pb-[70px] min-h-screen w-full text-center">
      ...
      <div>
        ...
        <div className='pt-20 px-[30px] space-y-[15px]'>
          ...
          <p className='text-[#C19799] text-[18px] px-5'>Hello fellow shoppers! We're currently building our new fashion store. Add your email below to stay up-to-date with announcements and our launch deals.</p>
          <Email />
        </div>
      </div>
    </div>
